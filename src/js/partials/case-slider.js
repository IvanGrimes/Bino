$(window).on("load",function(){
    $('.case-slider').coreSlider({
        ...
        sliderSelector: '.case-slider__list',                    // List selector (all items are inside this container)
        viewportSelector: '.case-slider__viewport',              // Viewport selector
        itemSelector: '.case-slider__item',                      // Slider items selector
        navEnabled: false,                                       // Enable/Disable navigation arrows
        navSelector: '.case-slider__nav',                        // Selector for navigation arrows container
        navItemNextSelector: '.case-slider__arrow_right',       // 'Next' arrow selector
        navItemPrevSelector: '.case-slider__arrow_left',        // 'Prev' arrow selector
        controlNavEnabled: true,                               // Enable/Disable control navigation (dots)
        controlNavSelector: '.case-slider__control-nav',         // Control navigation container selector (inside will be created dots items)
        controlNavItemSelector: 'case-slider__control-nav-item', // Single control nav dot (created dynamically. Write without dot. If you need more that one class - add them with space separator)
