$(window).on("load",function(){
    $('.header-slider').coreSlider({
        ...
        sliderSelector: '.header-slider__list',                    // List selector (all items are inside this container)
        viewportSelector: '.header-slider__viewport',              // Viewport selector
        itemSelector: '.header-slider__item',                      // Slider items selector
        navEnabled: true,                                       // Enable/Disable navigation arrows
        navSelector: '.header-slider__nav',                        // Selector for navigation arrows container
        navItemNextSelector: '.header-slider__arrow_right',       // 'Next' arrow selector
        navItemPrevSelector: '.header-slider__arrow_left',        // 'Prev' arrow selector
        controlNavEnabled: false,                               // Enable/Disable control navigation (dots)
        controlNavSelector: '.header-slider__control-nav',         // Control navigation container selector (inside will be created dots items)
        controlNavItemSelector: 'header-slider__control-nav-item', // Single control nav dot (created dynamically. Write without dot. If you need more that one class - add them with space separator)
